...
<section class=" text-green-800 py-20 text-center">
  ...
  <br>
   <a href="galerij.php" class="mt-8 inline-block bg-green-700 text-white px-8 py-4 rounded-full shadow-lg hover:bg-green-800 transition">
    Bekijk onze carnavalswagens
  </a>
</section>
